...
parser.add_argument("--folderlabel", type=str, default="txt", help="Folder that contain label")
...
def copy_image(file, id_folder):
    ...
    # labels (Commented because dataset doesn't have txt file)   
    separator = file.find(".")
    filename = file[0:separator]+".txt" 

    source = os.path.join(args.folderlabel, filename)
